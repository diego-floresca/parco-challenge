...
| `panel.html` | Panel interactivo autocontenido (vanilla JS, sin CDN, abre con doble clic). Vista triage + composición CX. Exporta `labels.csv`. |
...
- **Fingerprint por exact-match**: 23 plantillas exactas — no fuzzy matching, no embeddings, no LLM para agrupar. Ver `docs/EDA.md §2`.
- **Score de 5 componentes**: criticidad del servicio, desviación de la ficha histórica, tamaño de ráfaga, intensidad (high/critical/anomalía), novedad. Pesos en `config.yaml`. Ver `docs/EDA.md §9`.
